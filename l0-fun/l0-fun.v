...
Inductive step : term -> term -> Prop :=
 ...
 | e_let1       : forall x T v t2,     value v -> 
                                            step (letx x T v t2) (subs v x t2)
 | e_let2       : forall x T t1 t1' t2, step t1 t1' -> 
                                            step (letx x T t1 t2) (letx x T t1' t2)
 | e_letrec     : forall f T1 T2 y t1 t2, step (letrec f T1 T2 y t1 t2) 
                                               (subs (fn y T1 (letrec f T1 T2 y t1 t1)) f t2)
.
